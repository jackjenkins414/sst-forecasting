...
#
# n_heads must divide D_MODEL (128) evenly: valid choices are 4, 8, 16

SEARCH_SPACE = {
    "lr":       FloatDistribution(1e-4, 5e-3, log=True),  # 1e-3 worked; 1e-2 likely too high
    "n_heads":  CategoricalDistribution([4, 8]),           # 16 gives only 8 dims/head at d=128
    "n_layers": IntDistribution(2, 6),                     # 8 layers OOMs on 12 GB at P=297
    "lr_factor":FloatDistribution(0.3, 0.75),
    "alpha":    FloatDistribution(0.0, 0.5),               # 1.0 destabilised training; keep low
    "dropout":  FloatDistribution(0.05, 0.3),
}
